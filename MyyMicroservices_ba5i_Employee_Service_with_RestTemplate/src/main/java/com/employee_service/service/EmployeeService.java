...
//	@Autowired
	...
	// another way of having restTemplate
	...
	//	addRes = restTemplate.getForObject(addressBaseURL + "/emp/{empid}", AddressResponse.class,id);
		addRes = restTemplate.getForObject("/emp/{empid}", AddressResponse.class,id);
	...
	public List<EmployeeResponse> getAllEmployeesWithAddress()
	{
		...
		empRess.forEach(e -> e.setAddressResponse(
					...
					restTemplate.getForObject(
							"/emp/{empid}", AddressResponse.class,e.getId()	
						)
